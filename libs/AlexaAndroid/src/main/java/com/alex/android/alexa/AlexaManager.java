package com.alex.android.alexa;
...
import com.alex.android.alexa.callbacks.AuthorizationCallback;
import com.alex.android.alexa.data.Event;
import com.alex.android.alexa.interfaces.AvsException;
import com.alex.android.alexa.interfaces.AvsItem;
import com.alex.android.alexa.interfaces.AvsResponse;
import com.alex.android.alexa.interfaces.GenericSendEvent;
import com.alex.android.alexa.interfaces.audioplayer.AvsPlayAudioItem;
import com.alex.android.alexa.interfaces.response.ResponseParser;
import com.alex.android.alexa.interfaces.speechrecognizer.SpeechSendAudio;
import com.alex.android.alexa.interfaces.speechrecognizer.SpeechSendText;
import com.alex.android.alexa.interfaces.speechrecognizer.SpeechSendVoice;
import com.alex.android.alexa.interfaces.speechsynthesizer.AvsSpeakItem;
import com.alex.android.alexa.requestbody.DataRequestBody;
import com.alex.android.alexa.service.DownChannelService;
import com.alex.android.alexa.system.AndroidSystemHandler;
import com.alex.android.alexa.utility.Util;
...
import static com.alex.android.alexa.AuthorizationManager.createCodeVerifier;
import static com.alex.android.alexa.interfaces.response.ResponseParser.getBoundary;
import static com.alex.android.alexa.utility.Util.IDENTIFIER;
...
public class AlexaManager {
    ...
    /**
     * Send a synchronize state {@link Event} request to Alexa Servers to retrieve pending {@link com.alex.android.alexa.data.Directive}
     ...
     * See: {@link #sendEvent(String, AsyncCallback)}
     *
     * @param volume volume as reported by the {@link com.alex.android.alexa.interfaces.speaker.AvsAdjustVolumeItem} Directive
     ...
     * See: {@link #sendEvent(String, AsyncCallback)}
     *
     * @param isMute mute state as reported by the {@link com.alex.android.alexa.interfaces.speaker.AvsSetMuteItem} Directive
     * @param callback
     */
    ...
    /**
     * Send a generic event to the AVS server, this is generated using {@link com.alex.android.alexa.data.Event.Builder}
