package com.alex.android.alexa.interfaces;

import com.alex.android.alexa.callbacks.AsyncCallback;
import com.alex.android.alexa.connection.ClientUtil;
...
public abstract class SendEvent {
     ...
     * @param url the URL we're posting to, this is either the default {@link com.alex.android.alexa.data.Directive} or {@link com.alex.android.alexa.data.Event} URL
    ...
    /**
     * Get our JSON {@link com.alex.android.alexa.data.Event} for this call
     * @return the JSON representation of the {@link com.alex.android.alexa.data.Event}
     */
    @NotNull
